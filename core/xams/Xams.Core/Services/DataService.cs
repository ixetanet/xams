...
namespace Xams.Core.Services
{
        ...
        new()
    {
        ...
        private IDisposable? BeginOperationScope(string operation)
        {
        ...
        public async Task<Response<object?>> WhoAmI(Guid userId)
        {
            ...
            using var scope = BeginOperationScope("WhoAmI");
        ...
        public async Task<Response<ReadOutput>> Read(Guid userId, ReadInput readInput, PipelineContext? parent = null)
        {
            ...
            {
                ExecutingUserId = userId;
                using var scope = BeginOperationScope("Read");
        ...
        {
            ExecutingUserId = userId;
            using var scope = BeginOperationScope("Create");
        ...
        {
            ExecutingUserId = userId;
            using var scope = BeginOperationScope("Update");
            return await BulkExecute(userId, new BulkInput()
            {
        ...
        {
            ExecutingUserId = userId;
            using var scope = BeginOperationScope("Delete");
            return await BulkExecute(userId, new BulkInput()
            {
        ...
        {
            ExecutingUserId = userId;
            using var scope = BeginOperationScope("Upsert");
            return await BulkExecute(userId, new BulkInput()
            {
        ...
        {
            ExecutingUserId = userId;
            using var scope = BeginOperationScope("Bulk");
        ...
        {
            ExecutingUserId = userId;
            using var scope = BeginOperationScope($"Action:{input.name}");
        ...
        {
            ExecutingUserId = userId;
            using var scope = BeginOperationScope("Metadata");
        ...
        {
            ExecutingUserId = userId;
            using var scope = BeginOperationScope("Permissions");
        ...
        public async Task<Response<object?>> ExecuteTransaction(Guid userId, Func<PipelineContext,Task<Response<object?>>> action)
        {
            ...
            {
                Logger.LogError(e, "Transaction Failed: {Message}", e.Message);
                await _dataRepository.RollbackTransaction();
                return new Response<object?>()
                {
                    Succeeded = false,
        ...
        {
            using var scope = BeginOperationScope($"HubSend:{typeof(T).Name}");
            var hubType = typeof(T);
            var hubInstance = ActivatorUtilities.CreateInstance(ServiceProvider, hubType);
            ...
            var signalRInstance = ServiceProvider.GetRequiredService<IHubContext<SignalRHub>>();
            ...
            {
                Logger.LogError(e, "Failed to send message to hub {HubType}", hubType.Name);
                return new Response<object?>()
                {
                    Succeeded = false,
        ...
        private async Task<Response<object?>> BulkExecute(Guid userId, BulkInput input, bool returnArray)
        {
            ...
            {
                Logger.LogError(ex, "Bulk Operation Failed: {Message}", ex.Message);
                await _dataRepository.RollbackTransaction();
                throw;
            }
            finally
