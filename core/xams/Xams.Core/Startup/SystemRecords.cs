...
namespace Xams.Core.Startup
{
    public class SystemRecords
    {
        ...
        public async Task CreateSystemUser()
        {
            ...
            xamsDbContext.SetAuditEnabled(false);
        ...
        public async Task CreateSystemPermissions()
        {
            ...
            // Create Hub Permissions
            foreach (var serviceHub in Cache.Instance.ServiceHubs)
            {
                var serviceHubInfo = serviceHub.Value;
                permissionNames.Add($"HUB_{serviceHubInfo.ServiceHubAttribute.Name}");
            }
        ...
        public async Task CreateRolePermissions()
        {
            ...
            foreach (var permission in permissions)
            {
                ...
                if (!(permissionName.StartsWith("ACTION_") || 
                      ...
                      permissionName.StartsWith("HUB_") ||
