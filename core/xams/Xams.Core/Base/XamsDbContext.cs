...
namespace Xams.Core.Base
{
        ...
        where TSetting : Setting, new()
    {
        ...
        public IQueryable<Log> LogsBase => Set<Log>().IgnoreQueryFilters();
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Log>(entity =>
            {
                ...
                entity.HasIndex(l => l.SourceContext);
                entity.HasIndex(l => l.UserId);
                entity.HasIndex(l => l.CorrelationId);
                entity.HasIndex(l => l.RequestPath);
                entity.HasIndex(l => l.ExceptionType);
                entity.HasIndex(l => new { l.Timestamp, l.UserId });
                entity.HasIndex(l => l.Properties);
                
                // Large text fields
                entity.Property(l => l.Message).HasColumnType("text");
                entity.Property(l => l.MessageTemplate).HasColumnType("text");
                entity.Property(l => l.Exception).HasColumnType("text");
                entity.Property(l => l.Properties).HasColumnType("text");
                entity.Property(l => l.UserAgent).HasColumnType("text");
                entity.Property(l => l.ExceptionMessage).HasColumnType("text");
