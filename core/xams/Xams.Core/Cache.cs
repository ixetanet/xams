...
namespace Xams.Core
{
    public class Cache
    {
        ...
        public bool IsLogsEnabled { get; internal set; }
        ...
        internal static async Task Initialize(IDataService dataService)
        {
            ...
            // Preserve IsLogsEnabled setting from the existing instance
            var isLogsEnabled = Instance.IsLogsEnabled;
            Cache cache = new Cache();
            cache.IsLogsEnabled = isLogsEnabled;
            Instance = cache;
