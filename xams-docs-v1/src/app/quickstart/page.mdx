...
9. Run the project. You can access the admin dashboard by navigating to `/xams` in your browser. In development you can provide the user id of any user you want to impersonate via the query string. For example, to impersonate the SYSTEM user:

[http://localhost/xams?userid=f8a43b04-4752-4fda-a89f-62bebcd8240c](http://localhost:port/xams?userid=f8a43b04-4752-4fda-a89f-62bebcd8240c)
