...
<Note>
  The framework documentation provides Claude Code with essential knowledge about Xams architecture, patterns, and best practices. However, the copied files contain references to "MyXProject" and other Xams repository-specific paths that will need to be updated for your project.
</Note>
...
3. **Update framework references in .claude files:**
   - Replace "MyXProject" references with your actual project name
   - Update file paths to match your project structure
   - Correct any Xams repository-specific references to reflect your project

4. **Create/update .claude files:**
