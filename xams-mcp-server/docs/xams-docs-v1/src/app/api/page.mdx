...
## Create {{ tag: 'POST', label: '/xams/create' }}
...
<Row>
  <Col>
    <CodeGroup title="Request" tag="POST" label="/xams/create">
...
## Update {{ tag: 'PATCH', label: '/xams/update' }}
...
<Row>
  <Col>
    <CodeGroup title="Request" tag="POST" label="/xams/update">
...
## Delete {{ tag: 'DELETE', label: '/xams/delete' }}
...
<Row>
  <Col>
    <CodeGroup title="Request" tag="DELETE" label="/xams/delete">
...
## Upsert {{ tag: 'POST', label: '/xams/upsert' }}
...
<Row>
  <Col>
    <CodeGroup title="Request" tag="POST" label="/xams/upsert">
...
<Row>
  <Col>
    <CodeGroup title="Request" tag="POST" label="/xams/bulk">
...
<Row>
  <Col>
    <CodeGroup title="Request" tag="POST" label="/xams/read">
...
## Action {{ tag: 'POST', label: '/xams/action' }}
...
<Row>
  <Col>
    <CodeGroup title="Request" tag="POST" label="/xams/action">
...
<Row>
  <Col>
    <CodeGroup title="Request" tag="POST" label="/xams/file">
...
## Permissions {{ tag: 'POST', label: '/xams/permissions' }}
...
<Row>
  <Col>
    <CodeGroup title="Request" tag="POST" label="/xams/permissions">
...
## WhoAmI {{ tag: 'GET', label: '/xams/whoami' }}

This endpoint returns information about the currently authenticated user. It retrieves the user record from the User table using the current user's ID.

**Required Permissions:** `TABLE_User_READ_USER` (User level read permissions for the User table)

<Row>
  <Col>
    <CodeGroup title="Request" tag="GET" label="/xams/whoami">
...
## Metadata {{ tag: 'POST', label: '/xams/metadata' }}
