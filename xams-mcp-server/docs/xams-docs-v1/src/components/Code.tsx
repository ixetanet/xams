...
type languages = 'csharp' | 'jsx' | 'tsx' | 'javascript' | 'typescript'
...
function CodePanel({
  ...
  const codeExt = label?.split('.').pop() ?? 'typescript'
  let language = 'typescript' as languages
  ...
  return (
    <div className="group dark:bg-white/2.5">
      ...
      <div className="relative">
        <Highlighter codeBlock={code} language={language} />
