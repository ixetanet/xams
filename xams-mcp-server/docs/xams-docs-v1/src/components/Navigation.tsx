...
function ActivePageMarker({
  ...
  return (
    <motion.div
      layout
      className="absolute left-2 h-6 w-px bg-green-500"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1, transition: { delay: 0.2 } }}
      exit={{ opacity: 0 }}
      style={{ top }}
...
export const navigation: Array<NavGroup> = [
  ...
  },
  {
    ...
    links: [{ title: 'Firebase', href: '/firebaseauth' }],
  },
  // {
  //   title: 'React Components',
  //   links: [
  //     { title: 'useFormBuilder', href: '/formbuilder' },
  //     { title: 'Field', href: '/react_field' },
  //     { title: 'AppContext', href: '/appcontext' },
  //     { title: 'useAuthRequest', href: '/authrequest' },

  //     { title: 'DataTable', href: '/datatables' },
  //     { title: 'AdminDashboard', href: '/admindashboard' },
  //   ],
  // },
  // {
  //   title: 'API',
