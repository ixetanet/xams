...
const FeedbackThanks = forwardRef<React.ElementRef<'div'>>(
  function FeedbackThanks(_props, ref) {
    return (
      ...
      >
        <div className="flex items-center gap-3 rounded-full bg-green-50/50 py-1 pl-1.5 pr-3 text-sm text-green-900 ring-1 ring-inset ring-green-500/20 dark:bg-green-500/5 dark:text-green-200 dark:ring-green-500/30">
